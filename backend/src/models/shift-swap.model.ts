...
ShiftSwap.init(
  {
    ...
    status: { type: DataTypes.ENUM(...Object.values(ShiftSwapStatus)), allowNull: false, defaultValue: ShiftSwapStatus.PENDING_ACCEPTANCE },
    reviewNote: { type: DataTypes.STRING(240), allowNull: true },
    respondedAt: { type: DataTypes.DATE, allowNull: true },
    approverId: { type: DataTypes.INTEGER, allowNull: true },
    approvedAt: { type: DataTypes.DATE, allowNull: true }
  },
  { sequelize, tableName: 'shift_swaps' }
);
